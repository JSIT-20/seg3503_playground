...
public class DateNextDateExceptionTest
{
  ...
  public static List<Integer[]> data( )
  {
    ...
    //Added tests
    //Test for day > 31
    params.add(new Integer[] { 1975, 6, 35 });
    //Test for day == 31 on a 30 day month
    params.add(new Integer[] { 2000, 4, 31 });
    //Test for day <= 29 on leap year
    params.add(new Integer[] { 2024, 2, 30 });
    //Test for day <= 28 on non leap year
    params.add(new Integer[] { 2023, 2, 29 });
    //Test for month over 12
    params.add(new Integer[] { 2023, 0, 29 });
    return params;
  }
